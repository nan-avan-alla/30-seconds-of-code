...
* Visit [our website](https://30secondsofcode.org) to view the snippet collection.
* Use the [Search page](https://30secondsofcode.org/search) to find snippets that suit your requirement. You can search by name, tag, language or by using a snippet's description. 

Type a term and view the things appears
...
* Click on each snippet card to view the whole snippet i.e., code, explanation and examples.
